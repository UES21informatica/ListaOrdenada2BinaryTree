...
namespace BinaryTree
{
    public class BinaryTree
    {
        ...
        internal Node BuscarKesimo(Node node, int k)
        {
            Console.WriteLine("Buscar el " + k + " elemento");
            return Buscar(node.Right, k);


        }


        internal Node Buscar(Node node, int k)
        {
